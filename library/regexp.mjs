 ...
 * @param {Object<string, string> | string} target Map-like object of template expressions to regular expression names or a single regular expression name .
...
export const composePattern = (target, template) => {
  ...
  if (target instanceof Object) {
    pattern =
      ...
      '$';
  } else pattern = String(REGEXP[target]).replaceAll('\\-', '-').slice(1, -1);
